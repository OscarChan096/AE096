...
public class AdapterTareas extends BaseAdapter {
    ...
    protected ArrayList<homework> items;

    public AdapterTareas () {

    }

    public AdapterTareas (Activity activity, ArrayList<homework> items) {
        this.activity = activity;
        this.items = items;
    }

    public void UpdateList(ArrayList<homework> newlist) {
        items = newlist;
    ...
    public void addAll(ArrayList<homework> v) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            v = inf.inflate(R.layout.adapter_tareas, null);
        }
